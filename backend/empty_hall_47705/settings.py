"""
Django settings for empty_hall_47705 project.
...
ROOT_URLCONF = 'empty_hall_47705.urls'
...
WSGI_APPLICATION = 'empty_hall_47705.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "empty_hall_47705 API",
    "DESCRIPTION": "API documentation for empty_hall_47705 App",
    "VERSION": "v1",
}
